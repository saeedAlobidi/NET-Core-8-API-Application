        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_Leads_leadId",
                        column: x => x.leadId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Permission", "lead.read", 1 },
                    { 2, "Permission", "lead.write", 1 },
                    { 3, "Permission", "service.read", 1 },
                    { 4, "Permission", "service.write", 1 },
                    { 5, "Permission", "application.read", 1 },
                    { 6, "Permission", "application.write", 1 },
                    { 7, "Permission", "user.read", 1 },
                    { 8, "Permission", "user.write", 1 }
                });
